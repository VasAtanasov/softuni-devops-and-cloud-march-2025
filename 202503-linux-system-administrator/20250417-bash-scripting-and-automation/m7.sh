...
echo "* Working on $distro-based $platform machine ($fware) using $app to report"
...
echo '* '$tt' ...'
grep '#!/bin/bash' /home/$tu/user-data.sh &> /dev/null && grep -E 'echo|printf' /home/$tu/user-data.sh &> /dev/null && grep 'read' /home/$tu/user-data.sh &> /dev/null && grep 'user-data.dat' /home/$tu/user-data.sh &> /dev/null
if [ $? -eq 0 ]; then tr='PASS'; else tr='ERROR'; fi
echo '... '$tr
...
echo '* '$tt' ...'
grep '#!/bin/bash' /home/$tu/show-data.sh &> /dev/null && grep -E 'echo|printf' /home/$tu/show-data.sh &> /dev/null && grep 'exit' /home/$tu/show-data.sh &> /dev/null
if [ $? -eq 0 ]; then tr='PASS'; else tr='ERROR'; fi
echo '... '$tr
...
echo '* '$tt' ...'
grep '#!/bin/bash' /home/$tu/archiver.sh &> /dev/null && grep -E 'echo|printf' /home/$tu/archiver.sh &> /dev/null && grep 'exit' /home/$tu/archiver.sh &> /dev/null  && grep 'tar' /home/$tu/archiver.sh &> /dev/null
if [ $? -eq 0 ]; then tr='PASS'; else tr='ERROR'; fi
echo '... '$tr
